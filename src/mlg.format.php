...
class MlgParser {
	...
	private $reqFieldsForDataPoints = array(
		// additional fields
		IDX_IAT => ["iat", "mat"], IDX_MAF => "maf", IDX_MAP => "map", IDX_VBATT => "vbatt", IDX_LOAD => ["fuel_load", "engine_load", "fuelingLoad"], IDX_ADVANCE => "timing", IDX_MASS_FLOW => ["maf_air_flow", "air_flow"],
